  ...
  <body>
    <?php
      ...
      if ($_SERVER["REQUEST_METHOD"] == "POST" && ISSET($_REQUEST["action"]) && $_REQUEST["action"]=="search"){
        if ($_POST['nombre']!=''){
          $director = mysqli_real_escape_string($conn, $_POST['nombre']);
          $sql = "SELECT C.Nombre, P.Link FROM Contenido C, Director D, Director_Contenido DC, Plataforma P, Plataforma_Contenido PC 
          WHERE D.Nombre='$director' AND D.ID_Director=DC.ID_Director AND C.ID_Contenido=DC.ID_Contenido AND C.ID_Contenido = PC.ID_Contenido AND PC.ID_Plataforma = P.ID_Plataforma";
    ...
    <form method="post" action="<?php echo $_SERVER['PHP_SELF'];?>"> 
      Nombre del Director: <input type="text" name="nombre" value="<?php echo $director;?>"><br>
