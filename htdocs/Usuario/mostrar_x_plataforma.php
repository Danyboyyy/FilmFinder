  ...
  <body>
    <?php
      ...
      if ($_SERVER["REQUEST_METHOD"] == "POST" && ISSET($_REQUEST["action"]) && $_REQUEST["action"]=="search"){
        if ($_POST['nombre']!=''){
          $plataforma =  mysqli_real_escape_string($conn, $_POST['nombre']);
          $sql = "SELECT C.Nombre, P.Link FROM Contenido C, Plataforma P, Plataforma_Contenido PC 
          WHERE P.Nombre='$plataforma' AND P.ID_Plataforma=PC.ID_Plataforma AND C.ID_Contenido=PC.ID_Contenido";
    ...
    <form method="post" action="<?php echo $_SERVER['PHP_SELF'];?>"> 
      Nombre de la Plataforma: <input type="text" name="nombre" value="<?php echo $plataforma;?>"><br>
