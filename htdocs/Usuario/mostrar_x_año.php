<html>
  ...
  <body>
    <?php
      ...
      if ($_SERVER["REQUEST_METHOD"] == "POST" && ISSET($_REQUEST["action"]) && $_REQUEST["action"]=="search"){
        if ($_POST['nombre']!=''){
          ...
          WHERE Año=".$_POST['nombre']." AND C.ID_Contenido = PC.ID_Contenido AND PC.ID_Plataforma = P.ID_Plataforma";
    ...
    <form method="post" action="<?php echo $_SERVER['PHP_SELF'];?>"> 
      Año: <input type="number" name="nombre" value="<?php echo $año;?>"><br>
