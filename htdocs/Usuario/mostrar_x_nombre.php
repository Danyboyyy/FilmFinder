<html>
  ...
  <body>
    <?php
      ...
      if ($_SERVER["REQUEST_METHOD"] == "POST" && ISSET($_REQUEST["action"]) && $_REQUEST["action"]=="search"){
        if ($_POST['nombre']!=''){
          ...
          WHERE C.Nombre='$nombre' AND C.ID_Contenido = PC.ID_Contenido AND PC.ID_Plataforma = P.ID_Plataforma";
    ...
    <form method="post" action="<?php echo $_SERVER['PHP_SELF'];?>"> 
      Nombre del contenido: <input type="text" name="nombre" value="<?php echo $nombre;?>"><br>
