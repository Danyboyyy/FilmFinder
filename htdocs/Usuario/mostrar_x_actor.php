  ...
  <body>
    <?php
      ...
      if ($_SERVER["REQUEST_METHOD"] == "POST" && ISSET($_REQUEST["action"]) && $_REQUEST["action"]=="search"){
        if ($_POST['nombre']!=''){
          $actor = mysqli_real_escape_string($conn, $_POST['nombre']);

          $sql = "SELECT C.Nombre, P.Link FROM Contenido C, Actor A, Actor_Contenido AC, Plataforma P, Plataforma_Contenido PC
          WHERE A.Nombre='$actor' AND A.ID_Actor=AC.ID_Actor AND C.ID_Contenido=AC.ID_Contenido AND C.ID_Contenido = PC.ID_Contenido AND PC.ID_Plataforma = P.ID_Plataforma";
    ...
    <form method="post" action="<?php echo $_SERVER['PHP_SELF'];?>"> 
      Nombre del Actor: <input type="text" name="nombre" value="<?php echo $actor;?>"><br>
